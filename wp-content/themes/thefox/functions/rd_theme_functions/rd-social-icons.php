...
if (!function_exists('rd_social_icon')) {
 ...
 global $rd_data;	
	ob_start();
      ...
      <?php endif; ?>
      <?php //Checking if the icon is needed from the options panel ?>
      <?php if($rd_data['rd_xing_link'] !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      <div id="xing"> <a href="<?php echo esc_url($rd_data['rd_xing_link']) ?>" target="_blank" ><i class="fa fa-xing"></i></a></div>
      <?php endif; ?>
      <?php //Checking if the icon is needed from the options panel ?>
      <?php if($rd_data['rd_vk_link'] !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      <div id="vk"> <a href="<?php echo esc_url($rd_data['rd_vk_link']) ?>" target="_blank" ><i class="fa fa-vk"></i></a></div>
      <?php endif; ?>
      <?php //Checking if the icon is needed from the options panel ?>
