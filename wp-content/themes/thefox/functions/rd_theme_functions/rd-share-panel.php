...
?>
   <div class="share-box">
      <ul>
        ...
        <li id="gplus"> <a  target="_blank" onClick="popup = window.open('https://plus.google.com/share?url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>', 'PopupPage', 'height=450,width=500,scrollbars=yes,resizable=yes'); return false" href="#"><i class="fa fa-google-plus"></i></a>
         </li>
