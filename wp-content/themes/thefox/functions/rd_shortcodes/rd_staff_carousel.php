...
if($type == 'rstaff_04'){
	...
	jQuery(document).ready(function($) {
		...
		$(".rd_'.$staff_id.'.staff_sc ul").carouFredSel({
					responsive: true,
					width: "100%",';
...
<div class="recent_port_ctn clearfix">
    ...
    <a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>"><?php if($type == 'rstaff_02'){  echo the_post_thumbnail( array(586, 440), array('title' => "")); }else{ echo the_post_thumbnail( 'staff_tn', array('title' => "")); } ?></a>
