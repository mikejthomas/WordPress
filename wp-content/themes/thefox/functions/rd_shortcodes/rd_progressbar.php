...
if($border_color == ''){
	...
	if($percentage < 101){
$output ='<style type="text/css" >#pb_'.$pbid.' .pb_title,#pb_'.$pbid.' .pb_sub_title,#pb_'.$pbid.' .pb_sub_percentage,.rd_pb_1 #pb_'.$pbid.' .pb_percentage,.rd_pb_2 #pb_'.$pbid.' .pb_percentage,.rd_pb_7 #pb_'.$pbid.' .pb_percentage{color:'.$title_color.';}';
if ($pb_alt_color !== '') {
