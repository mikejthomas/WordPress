...
if (!function_exists('rd_social_sc')) {
 ...
 global $rd_data;	
	...
	<?php
	 ...
	 if($google !== '') : ?>
      ...
      <?php if($skype !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      <div id="skype" class="<?php echo esc_attr($animation) ?>"> <a href="<?php echo esc_attr($skype) ?>"  target="_blank"><i class="fa fa-skype"></i></a></div>
      <?php $i ++; endif; ?>
      <?php //Checking if the icon is needed from the options panel ?>
      <?php if($pinterest !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      ...
      <?php if($xing !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      <div id="xing" class="<?php echo esc_attr($animation) ?>"> <a href="<?php echo esc_url($xing) ?>" target="_blank" ><i class="fa fa-xing"></i></a></div>
      <?php $i ++; endif; ?><?php //Checking if the icon is needed from the options panel ?>
      <?php if($vk !== '') : ?>
      <?php //Using the icon link from the options panel ?>
      <div id="vk" class="<?php echo esc_attr($animation) ?>"> <a href="<?php echo esc_url($vk) ?>" target="_blank" ><i class="fa fa-vk"></i></a></div>
      <?php $i ++; endif; ?>
      <?php //Checking if the icon is needed from the options panel ?>
      <?php if($rss !== '') : ?>
