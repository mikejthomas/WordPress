...
if ($width !== ''){
echo '<style type="text/css" >#rd_'.$id.' {width:'.$width.'px;}</style>';
}
echo '<style type="text/css" >#rd_'.$id.' {margin-top:'.$margin_top.'px; margin-bottom:'.$margin_bottom.'px;}#rd_'.$id.' #search input[type=text]{background:'.$bg_color.'; border:1px solid '.$b_color.'; color:'.$t_color.'; border-radius:'.$radius.'px;}#rd_'.$id.' #search input[type=submit]{color:'.$t_color.'}#rd_'.$id.' #search input[type=submit]:hover{color:'.$h_color.'}</style>';
