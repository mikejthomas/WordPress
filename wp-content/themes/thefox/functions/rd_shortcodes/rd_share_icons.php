...
?>
   ...
   <?php } if($gplus !== ''){ ?>     
        <li id="gplus" <?php if($animation !== ''){echo 'class="'.$animation.'"';} ?>> <a  target="_blank" onClick="popup = window.open('https://plus.google.com/share?url=<?php echo esc_attr($url); ?>&amp;title=<?php echo esc_attr($msg); ?>', 'PopupPage', 'height=450,width=500,scrollbars=yes,resizable=yes'); return false" href="#"><i class="fa fa-google-plus"></i></a>
         </li>
