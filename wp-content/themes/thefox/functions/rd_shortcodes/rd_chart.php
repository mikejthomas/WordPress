...
$pc_id = RandomString(20);
	$output = '<style type="text/css" >#rd_'.$pc_id.' {margin-top:'.$margin_top.'; margin-bottom:'.$margin_bottom.';}#rd_'.$pc_id.' .rd_pc_status{color:'.$p_color.';}#rd_'.$pc_id.' .rd_pc_heading{color:'.$heading_color.';}#rd_'.$pc_id.' .rd_pc_text{color:'.$text_color.';}</style>';
