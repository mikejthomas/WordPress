...
// Enqueue the CSS
  ...
  global $iconContents;
		...
		$ret = "<style type='text/css'>
			...
			if( !empty ($iconCode) ){
		$ret .= "#l_".$id." .". $atts['icon'] . ":before { content: \"" . $iconCode . "\"; $ligatureStyle }
";
		}
...
$output .='<style type="text/css" >#l_'.$id.'.rd_icon_line_l{height:'.$ctn_size.'px;}#l_'.$id.'.rd_icon_line_l i{line-height:'.$icon_size.'px; width:'.$icon_size.'px ; font-size:'.$icon_size.'px; color:'.$icon_color.' ; }#l_'.$id.' .sc_line{margin:'.$top_m.'px 0 0 '.$left_m.'px;}</style>';
...
$output .='<style type="text/css" >#l_'.$id.'.rd_icon_line_r{height:'.$ctn_size.'px;}#l_'.$id.'.rd_icon_line_r i{line-height:'.$icon_size.'px; width:'.$icon_size.'px ; font-size:'.$icon_size.'px; color:'.$icon_color.' ; }#l_'.$id.' .sc_line{margin:'.$top_m.'px '.$right_m.'px 0 0;}</style>';
