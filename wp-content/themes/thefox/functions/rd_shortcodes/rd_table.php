...
$output = '<style type="text/css" >#t_'.$table_id.' .table_col {color:'.$text_color.'; background:'.$bg_color.';}#t_'.$table_id.' .table_col .table_line_ctn {border:1px solid '.$border_color.';}#t_'.$table_id.' .table_col .table_line {border-bottom:1px solid '.$border_color.';} </style>  ';
