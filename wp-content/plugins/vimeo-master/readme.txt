...
= 4.4.2.7 =
* fixing string offset if error reporting is set to max
...
= 4.4.2.4 =
* Adding better support for https
...
* Vimeo Button Tweaked

= 4.3.7 =
* Adding better widget compatibility for Sidebar areas
...
* Adding index SEC
* New Vimeo API with more player options
* New Widgets
...
* Auto-play and Loop API changes

= 2.3 =
* fixed hook invitation
