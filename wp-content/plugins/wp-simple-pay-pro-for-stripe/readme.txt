...
= 2.5.2 - November 11, 2016 =

* Fix: Amount getting set to zero on initial load of radio button list of amounts.
* Tweak: Save shipping address fields to designated Stripe charge property instead of metadata.
* Dev: Add action hook to run immediately after Stripe PHP library is loaded.
...
= 2.5.1 - October 27, 2016 =

* Fix: Additional check for Lite version active.

= 2.5.0 - October 20, 2016 =

* Fix: Corrected test mode not getting set correctly when using new alternate Stripe API key filters.

= 2.4.9 - October 17, 2016 =
...
= 2.4.8 - October 6, 2016 =

* Fix: Better timing when resetting "Pay with Card" button after back button navigation.
