...
if ( ! defined( 'SIMPAY_PRO_VERSION' ) ) {
	define( 'SIMPAY_PRO_VERSION', '2.5.2' );
}

// Also define base plugin version for some uses.
// Check for existence of SP Lite constant to avoid errors.
if ( ! defined( 'SIMPAY_VERSION' ) ) {
	define( 'SIMPAY_VERSION', SIMPAY_PRO_VERSION );
}

// Plugin name
if ( ! defined( 'SIMPAY_NAME' ) ) {
	define( 'SIMPAY_NAME', 'WP Simple Pay Pro for Stripe' );
}
